#############################################################################
# Makefile for building: pomodoro-clock
# Generated by qmake (3.1) (Qt 5.15.19)
# Project:  pomodoro-clock.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile pomodoro-clock.pro
#############################################################################
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = pomodoro-clock1.0.0
DISTDIR = /home/alan/Documentos/pomodoro-clock/.tmp/pomodoro-clock1.0.0
LINK          = g++
...
DIST          = /usr/lib/qt/mkspecs/features/spec_pre.prf \
		...
		pomodoro-clock.pro include/main.hpp src/main.cpp
QMAKE_TARGET  = pomodoro-clock
DESTDIR       = 
TARGET        = pomodoro-clock


first: all
####### Build rules

pomodoro-clock:  $(OBJECTS)  
	$(LINK) $(LFLAGS) -o $(TARGET) $(OBJECTS) $(OBJCOMP) $(LIBS)

Makefile: pomodoro-clock.pro /usr/lib/qt/mkspecs/linux-g++/qmake.conf /usr/lib/qt/mkspecs/features/spec_pre.prf \
		/usr/lib/qt/mkspecs/common/unix.conf \
		/usr/lib/qt/mkspecs/common/linux.conf \
		/usr/lib/qt/mkspecs/common/sanitize.conf \
		/usr/lib/qt/mkspecs/common/gcc-base.conf \
		...
		/usr/lib/qt/mkspecs/features/lex.prf \
		pomodoro-clock.pro
	$(QMAKE) -o Makefile pomodoro-clock.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/main.hpp $(DISTDIR)/

...
0xbc,0x6,0x0,0x0,0xb2,0x77,0x3d,0x7f,
0xa2,0x3c,0xcb,0xc3,0x55,0xd0,0xb6,0x30,
0x3b,0x98,0xb6,0xc8,0x0,0x0,0x0,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
0x18,0x7,0x12,0x14,0x80,0x7,0x18,0x8,
0x2e,0x2,0x3c,0x3,0x18,0x9,0x10,0xa,
0x68,0x9,0x50,0x4,0x12,0x16,0x4c,0x2,
0x12,0x0,0x80,0x8,0x18,0x9,0x2e,0x4,
0x3c,0x5,0x80,0x9,0x18,0x6,0x2,0x0,
0x0,0x0,0x0,0x0,0x0,0x0,0x0,0x0,
...
#endif
while (!aotContext->getObjectLookup(3, s.v2_12, &s.v2_14)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(16);
#endif
aotContext->initGetObjectLookup(3, s.v2_12);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<QString *>(argv[0]) = QString();
...
label_1:;
// generate_Add
s.v2_30 = QString(s.v2_8 + s.c2_30);
{
}
// generate_StoreReg
{
...
#endif
while (!aotContext->loadContextIdLookup(4, &s.v2_34)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(36);
#endif
...
#endif
while (!aotContext->getObjectLookup(5, s.v2_34, &retrieved)) {
#ifdef QT_NO_DEBUG
aotContext->setInstructionPointer(38);
#endif
aotContext->initGetObjectLookup(5, s.v2_34);
if (aotContext->engine->hasError()) {
aotContext->setReturnValueUndefined();
if (argv[0]) {
    *static_cast<QString *>(argv[0]) = QString();
...
s.v2_36 = QJSPrimitiveValue(std::move(retrieved)).toString();
}
{
}
// generate_Add
s.v2_38 = QString(std::move(s.v2_30) + std::move(s.v2_36));
{
}
{
}
